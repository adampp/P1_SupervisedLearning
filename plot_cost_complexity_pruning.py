...
def plot_cost_complexity_pruning(clf, X, y, testSize, title, xlim):
    ###############################################################################
    ...
    ax[0].plot(ccp_alphas, test_scores, marker='o', label="validation",
            drawstyle="steps-post")
    ax[0].legend()
    ...
    ax[1].set_xlim(xlim)
    ax[1].plot(ccp_alphas, train_scores, marker='o', label="train",
            drawstyle="steps-post")
    ax[1].plot(ccp_alphas, test_scores, marker='o', label="validation",
            drawstyle="steps-post")
    ax[1].legend()
    
    resultStr = f"test score={np.max(test_scores)}, index={np.argmax(test_scores)}, ccp_alpha={ccp_alphas[np.argmax(test_scores)]}"
    print(resultStr)
